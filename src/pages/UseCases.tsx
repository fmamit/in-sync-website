    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                See how Insync's powerful features adapt to your specific industry needs across India's diverse business landscape
              </p>
            </div>
        ...
        <section className="py-20 bg-gradient-to-b from-slate-50/30 to-background">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold mb-4">Insync vs Competition</h2>
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                See how Insync compares with leading CRM and business automation platforms in the Indian market
              </p>
            </div>
            ...
            <div className="mt-12 bg-primary/5 rounded-lg p-8">
              <h3 className="text-2xl font-bold mb-6 text-center">Insync's Unique Advantages</h3>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-xl mb-8 opacity-90">
                Join thousands of Indian businesses already using Insync to grow faster and serve customers better
              </p>
